...
namespace ShopProject.EFDB.Migrations
{
    ...
    [Migration("20240318181149_Token_logins")]
    partial class Token_logins
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShopProject.EFDB.Models.TokenLogin", b =>
                {
                    ...
                    b.HasKey("TokenLoginId")
                        .HasName("Token_logins_pkey");

                    b.ToTable("Token_Logins", (string)null);
                });
