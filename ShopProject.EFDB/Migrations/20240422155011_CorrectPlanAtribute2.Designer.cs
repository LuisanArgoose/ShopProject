...
namespace ShopProject.EFDB.Migrations
{
    ...
    [Migration("20240422155011_CorrectPlanAtribute2")]
    partial class CorrectPlanAtribute2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopProject.EFDB.Models.PlanAtribute", b =>
                {
                    b.Property<int>("PlanAtributeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("PlanAtributeId"));

                    b.Property<string>("AtributeName")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("AtributeViewName")
                        .IsRequired()
                        .HasColumnType("text");

                    b.HasKey("PlanAtributeId");

                    b.ToTable("PlanAtributes");
                });
            ...
            modelBuilder.Entity("ShopProject.EFDB.Models.ShopPlan", b =>
                {
                    ...
                    b.Property<decimal>("AtributeValue")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("ShopProject.EFDB.Models.ShopPlan", b =>
                {
                    b.HasOne("ShopProject.EFDB.Models.PlanAtribute", "PlanAtribute")
                        .WithMany("ShopPlans")
                        .HasForeignKey("PlanAtributeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
